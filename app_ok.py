...
def inject_css():
    ...
    * {{ font-family: 'Inter', sans-serif !important; }}
    ...
    /* ── Masquer éléments Streamlit sans casser le toggle sidebar ── */
    #MainMenu {{ visibility: hidden; }}
    footer {{ visibility: hidden; }}
    /* Cacher uniquement le branding dans le header, PAS le header entier */
    ...
    [data-testid="stSidebarCollapsedControl"] {{
        ...
        background-color: {AFB_RED} !important;
    ...
    [data-testid="stSidebar"] {{
        ...
        border-right: 3px solid {AFB_RED} !important;
    }}

    /* ── Texte dans la sidebar (ciblé, pas de wildcard *) ── */
    [data-testid="stSidebar"] p,
    [data-testid="stSidebar"] span,
    [data-testid="stSidebar"] label,
    [data-testid="stSidebar"] div {{ color: #DDDDDD; }}
